...
<head>
    ...
    <title>The Coffee Buzz - Home</title>
...
<body>
	...
	if (isset($_GET["logout"])) {
		...
		if ($_GET["logout"] == "true") { ?>
				...
				<strong>You have been logged out of the Webpage</strong>
				</div>
	<?php 
		}
	}
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img class="img-responsive img-full" src="./img/image1.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="./img/image2.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="./img/image3.jpeg" alt="">
                            </div>
                    ...
                    <h1 class="brand-name">The Coffee Buzz </h1>
